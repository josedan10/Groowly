...
<div class="flex-center main">
    <form action="{{ url('/admin/relaciones/edit') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea class="form-input ckeditor" type="text" id="paragraph1" name="paragraph1" placeholder="Write here...">@if($relaciones) {{$relaciones->paragraph1}} @endif</textarea>
        </div>
        <div class="form-group">
            <label class="form-label" for="paragraph2">Parrafo 2</label>
            <textarea class="form-input ckeditor" type="text" id="paragraph2" name="paragraph2" placeholder="Write here...">@if($relaciones) {{$relaciones->paragraph2}} @endif</textarea>
        </div>
