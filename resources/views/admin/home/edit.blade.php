...
<div class="flex-center main">
    <form action="{{ url('/admin/home/edit') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea class="form-input ckeditor" type="text" id="paragraph1" name="paragraph1"  placeholder="Write here...">@if($home) {{$home->paragraph1}} @endif</textarea>
        </div>
        <div class="form-group">
