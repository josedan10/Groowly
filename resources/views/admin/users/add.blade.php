...
<div class="flex-center main">
    <form action="{{ url('/admin/home/edit') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea class="form-input ckeditor" type="text" id="paragraph1" name="paragraph1" @if($home)'value="'.$home->paragraph1.'"'@endif placeholder="Write here..."></textarea>
        </div>
        <div class="form-group">
                <label class="form-label" for="paragraph2">Parrafo 2</label>
                <textarea class="form-input ckeditor" type="text" id="paragraph2" name="paragraph2" @if($home)'value="'.$home->paragraph2.'"'@endif placeholder="Write here..."></textarea>
            </div>
